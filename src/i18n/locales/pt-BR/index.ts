...
export const ptBR: I18nResource = {
  common: {
    ...
    deleteDialog: {
      single: {
        title: "Excluir Item",
        description:
          'Tem certeza que deseja excluir "{{label}}"? Esta ação removerá permanentemente o item e não pode ser desfeita.',
      },
      multi: {
        title: "Excluir {{count}} itens",
        description:
          "Tem certeza que deseja excluir os {{count}} itens selecionados? Esta ação não pode ser desfeita.",
        deafultConfirmWord: "EXCLUIR",
      },
      confirm: {
        label: "Confirme digitando o nome do item",
        placeholder:
          'Digite o nome do item "{{label}}" para confirmar a exclusão',
      ...
      form_builder: {
        form: {
          ...
          questions: {
            ...
            alert:
              "Adicione pelo menos uma pergunta ao formulário antes de salvá-lo.",
            empty: {
  ...
  profiles: {
    ...
    create: {
      ...
      description:
        "Crie um novo perfil para organizar seus usuários e definir suas permissões.",
      form: {
        name: {
  ...
  users: {
    ...
    create: {
      ...
      description:
        "Crie um novo usuário para participar da sua equipe enviando um convite por e-mail e atribua uma função para definir o nível de acesso dele.",
      submit: {
        message:
          "Convite enviado. Um e-mail com os próximos passos foi enviado.",
      },
      form: {
        cpf: {
          label: "CPF",
        ...
        description: {
          ...
          placeholder:
            "Adicione uma mensagem pessoal para enviar a este usuário no seu convite (opcional)",
        },
      },
      actions: {
        cancel: "Cancelar",
  ...
  settings: {
    ...
    account: {
      title: "Conta",
      description:
        "Atualize as configurações da sua conta. Defina seu idioma e fuso horário preferido.",
      form: {
        name: {
          label: "Nome",
          placeholder: "Seu nome",
          description:
            "Este é o nome que será mostrado no seu perfil e em emails.",
          validation: {
            required: "Nome é obrigatório",
        ...
        language: {
          ...
          description: "Esse é o idioma que será usado no Dashboard.",
        },
        theme: {
          label: "Tema",
        },
    ...
    notifications: {
      ...
      form: {
        notifyMe: {
          label: "Notifique-me sobre...",
          options: {
            all: "Todas as novas mensagens",
            mentions: "Mensagens diretas e menções",
            none: "Nada",
          },
          validation: {
            required: "Por favor, selecione um tipo de notificação.",
          },
        },
        emailNotifications: {
          label: "Notificações por Email",
          communication: {
            label: "Emails de comunicação",
            description: "Receba emails sobre a atividade da sua conta.",
          },
          marketing: {
            label: "Emails de marketing",
            description: "Receba emails sobre novos produtos, recursos e mais.",
          },
          social: {
            label: "Emails sociais",
            description:
              "Receba emails de solicitações de amizade, seguidores e mais.",
          },
          security: {
            label: "Emails de segurança",
            description:
              "Receba emails sobre a atividade e segurança da sua conta.",
          },
        },
        mobile: {
          label: "Usar configurações diferentes para meus dispositivos móveis",
          description:
            "Você pode gerenciar suas notificações móveis na página de",
          link: "configurações móveis",
        },
