...
export const enUS: I18nResource = {
  common: {
    ...
    deleteDialog: {
      single: {
        title: "Delete Item",
        description:
          'Are you sure you want to delete "{{label}}"? This action will permanently remove the item and cannot be undone.',
      },
      multi: {
  ...
  profiles: {
    ...
    create: {
      ...
      description:
        "Create a new profile to organize your users and set their permissions.",
      form: {
        name: {
          label: "Profile Name",
          validation: {
  ...
  users: {
    ...
    create: {
      ...
      description:
        "Create a new user to join your team by sending an email invitation and assign a role to set their access level.",
      submit: {
      ...
      form: {
        ...
        description: {
          ...
          placeholder:
            "Add a personal message to send to this user in your invitation (optional)",
        },
      },
      actions: {
        cancel: "Cancel",
