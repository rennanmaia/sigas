...
export const formResponses: FormResponse[] = [
  ...
  },
  {
    ...
    submittedBy: "Camila Ferreira",
    answers: {
      "q-text": "Camila Ferreira Dias",
      "q-textarea": "Solo com alta umidade. Vegetação densa ao redor.",
      "q-number": 33,
      "q-select": "norte",
      "q-checkbox": ["gps", "camera"],
      "q-date": "2026-01-27",
      "q-map": "lat:-2.7692,lng:-55.3093",
    },
  },
  {
    id: "resp-23",
    ...
    submittedBy: "Marcos Albuquerque",
    answers: {
      "q-text": "Marcos Albuquerque Neto",
      "q-textarea": "Coleta próxima ao igarapé. Amostras de água coletadas.",
      "q-number": 19,
      "q-select": "norte",
      "q-checkbox": ["gps", "medidor-ph"],
      "q-date": "2026-01-27",
      "q-map": "lat:-2.7708,lng:-55.3082",
    },
  },
  {
    id: "resp-24",
    formId: "frm-3",
    submittedAt: "2026-01-28T07:45:00Z",
    submittedBy: "Renata Moura",
    answers: {
      "q-text": "Renata Moura Cavalcante",
      "q-textarea": "Presença de espécies invasoras identificada na margem.",
      "q-number": 44,
      "q-select": "norte",
      "q-checkbox": ["gps", "camera", "termometro"],
      "q-date": "2026-01-28",
      "q-map": "lat:-2.7684,lng:-55.3077",
    },
  },
  {
    id: "resp-25",
    ...
    submittedBy: "Felipe Barros",
    answers: {
      "q-text": "Felipe Barros Monteiro",
      "q-textarea":
        "Temperatura elevada registrada. Coleta em horário de pico solar.",
      "q-number": 27,
      "q-select": "norte",
      "q-checkbox": ["gps"],
      "q-date": "2026-01-28",
      "q-map": "lat:-2.7719,lng:-55.3065",
    },
  },
  {
    id: "resp-26",
    formId: "frm-3",
    submittedAt: "2026-01-29T09:15:00Z",
    submittedBy: "Aline Nascimento",
    answers: {
      "q-text": "Aline Nascimento Figueiredo",
      "q-textarea":
        "Área de preservação permanente. Protocolo seguido rigorosamente.",
      "q-number": 36,
      "q-select": "norte",
      "q-checkbox": ["gps", "camera", "drone"],
      "q-date": "2026-01-29",
      "q-map": "lat:-2.7697,lng:-55.3103",
    },
  },
  {
    id: "resp-27",
    formId: "frm-3",
    submittedAt: "2026-01-29T11:50:00Z",
    submittedBy: "Davi Carvalho",
    answers: {
      "q-text": "Davi Carvalho Pinto",
      "q-textarea": "Monitoramento de nascentes realizado com sucesso.",
      "q-number": 21,
      "q-select": "norte",
      "q-checkbox": ["gps", "medidor-ph", "termometro"],
      "q-date": "2026-01-29",
      "q-map": "lat:-2.7705,lng:-55.3088",
    },
  },
];
