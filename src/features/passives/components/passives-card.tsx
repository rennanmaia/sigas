...
export function PassiveCard({
    ...
    return (
        <Card key={item.id} className="cursor-pointer shadow-sm hover:shadow-md transition-shadow relative overflow-hidden border-none shadow-sm transition-all duration-300 group">
