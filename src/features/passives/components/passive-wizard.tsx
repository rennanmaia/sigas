...
import { BasicInfoStep, DocumentationStep } from "./wizard-steps";
...
const steps = [
  {
    ...
    description: "Dados principais do passivo",
  },
  {
    id: 2,
    title: "Documentação",
    description: "Evidências, auditorias e campos personalizados",
  },
];

export function PassiveWizard({
  onSubmit,
  isLoading = false,
  initialData,
}: LiabilityWizardProps) {
