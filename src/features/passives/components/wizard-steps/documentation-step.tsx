    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        <div>
          ...
          <FormDescription>
            Anexe evidências, planos de ação, relatórios de auditoria e outros
        ...
        <Card className="p-4 bg-blue-50 dark:bg-blue-950 border-blue-200 dark:border-blue-900">
          ...
          <div className="space-y-2 text-sm">
            <div className="flex items-center gap-2">
              ...
              <span>
                <strong>Evidência:</strong> Fotos, vídeos, dados que comprovam o
                passivo
              </span>
            </div>
            <div className="flex items-center gap-2">
              ...
              <span>
                <strong>Plano:</strong> Documentos de planejamento e ação
                corretiva
              </span>
            </div>
            <div className="flex items-center gap-2">
              ...
              <span>
                <strong>Auditoria:</strong> Relatórios de auditoria e
                conformidade
              </span>
            </div>
            <div className="flex items-center gap-2">
              ...
              <span>
                <strong>Outro:</strong> Documentos complementares
              </span>
            </div>
          </div>
        </Card>
        ...
        <div className="space-y-2">
          <p className="text-sm font-medium">
            Documentos anexados ({uploadedDocs.length})
          </p>
          <div className="space-y-2">
            {uploadedDocs.length > 0 ? (
              ...
              <p className="text-xs text-muted-foreground text-center py-4">
                Nenhum documento anexado ainda. Adicione arquivos para registrar
                evidências do passivo.
              </p>
            )}
          </div>
        </div>
