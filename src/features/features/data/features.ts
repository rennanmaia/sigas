...
export const FEATURE_GROUPS: FeatureGroup[] = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        id: "functionalities.add_to_profile",
        label: "Adicionar funcionalidade ao perfil",
      },
      {
        id: "functionalities.delete_from_profile",
        label: "Remover funcionalidade do perfil",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    children: [
      {
        id: "reports.data_collection_researcher",
        label: "Coleta de dados por pesquisador",
      },
      {
        id: "reports.by_questionnaire",
        label: "Coleta de dados por questionário",
      },
      {
        id: "reports.view_responses_map",
        label: "Visualizar respostas no mapa",
      },
    ],
  },
  {
